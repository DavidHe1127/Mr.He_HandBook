...
- By default on every instance reboot, the EBS volumes other than the root one will get unmounted. To enable automount, you need to make an entry in the /etc/fstab file
