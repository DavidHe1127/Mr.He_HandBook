...
* To update a template, we cannot edit the earlier version directly. We have to re-upload a new version of the template and AWS will be able work out what's need to be changed by comparing the two.
